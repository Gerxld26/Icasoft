...
const progressBarAntivirus = document.getElementById('progressBarAntivirus').querySelector('span');
...
const contenedorLogsAnimados = document.getElementById('contenedor-logs-animados');
    ...
    return new Promise(resolve => {
        ...
        const intervalo = setInterval(() => {
            ...
            if (progreso >= porcentaje) {
                ...
                progressBarAntivirus.style.width = `${progreso}%`; // Sincronización
                progressBarAntivirus.textContent = `${Math.floor(progreso)}%`;
            ...
            if (porcentaje === 100) {
                contenedorLogsAnimados.style.display = 'none';
                verAntivirus.style.display = 'grid';
                listaArchivosEscaneados.style.height = '90px';
            }
...
async function realizarEscaneoAntivirus() {
    ...
    try {
        ...
        verAntivirus.addEventListener('click', () => {
